...
# swagger-ui-bundle 1.1.0 ships Swagger UI 4.15.5, which does not render the
# OpenAPI 3.1 document generated by current FastAPI releases. FastAPI exposes
# openapi_version specifically so compatible tooling can consume a 3.0.x
# schema; use 3.0.3 for this local/offline Swagger UI.
