...
def search_documents(
    ...
    """Search documents using dense, sparse BM25, or hybrid RRF retrieval."""
    if top_k < 1:
    ...
    if mode in {"sparse", "hybrid"}:
        sparse_hits = [
            ...
            for hit in BM25Index(_tenant_documents(tenant_id)).search(query, candidate_k)
        ]
    ...
    if mode == "dense":
        ...
        ranked = reciprocal_rank_fusion([dense, sparse_hits])
