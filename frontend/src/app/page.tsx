...
export default function Dashboard() {
  const [activeTab, setActiveTab] = useState<'library' | 'chat' | 'agents'>('library');
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-neutral-100 font-sans selection:bg-indigo-500/30">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        {activeTab === 'chat' && (
          <div className="max-w-4xl mx-auto h-[calc(100vh-10rem)] fade-in">
            <ChatInterface />
          </div>
        )}
